package com.nz2dev.wordtrainer.app.presentation.structures;
 ...
 */
public class LanguageStructuresHolder {

    public static LanguageStructuresHolder withRoot(View rootView) {
        return new LanguageStructuresHolder(rootView);
    }
    ...
    private LanguageStructuresHolder(View root) {
